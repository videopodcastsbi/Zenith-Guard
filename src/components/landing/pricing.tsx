...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 relative z-10 bg-[#0a0a0f]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Simple, transparent pricing</h2>
          <p className="text-gray-400 text-lg">Choose the right plan for your games, from indie developers to enterprise studios.</p>
        </div>
          ...
          {tiers.map((tier, index) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-400 mt-4 text-sm h-10">{tier.description}</p>
              </div>
